...
/**
 * Test case for class Tx_Dl_dropboxsync_Controller_SyncConfigurationController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_dropboxsync_Controller_SyncConfigurationControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
