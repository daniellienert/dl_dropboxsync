...
/**
 * Test case for class Tx_Dl_dropboxsync_Controller_FileMetaController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_dropboxsync_Controller_FileMetaControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
